...
func main() {
	...
	cview.Styles.PrimaryTextColor = pink
	// Search field
	cview.Styles.ContrastBackgroundColor = purple
	cview.Styles.BorderColor = pink

	cview.Styles.SecondaryTextColor = tcell.ColorAntiqueWhite
	cview.Styles.TertiaryTextColor = purple
	cview.Styles.MoreContrastBackgroundColor = purple

	// cview.Styles.BorderColor = tcell.NewRGBColor(66, 32, 42)
	...
	frame.AddText("Youtube Music CLI", true, cview.AlignCenter, tcell.ColorAntiqueWhite)
